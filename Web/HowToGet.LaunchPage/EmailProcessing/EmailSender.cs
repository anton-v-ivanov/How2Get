...
namespace LaunchPage.EmailProcessing
{
	internal class EmailSender
	{
		...
		{
			using (var client = new SmtpClient(NotificationsConfig.Host, NotificationsConfig.Port))
			{
				client.Credentials = new System.Net.NetworkCredential(NotificationsConfig.Name, NotificationsConfig.Password);
