...
{
	public class UpdateDateTimeRanker : BasePartialRanker, IPartialRanker
	{
		public PriorityInfo Priorities { get; private set; }

		public UpdateDateTimeRanker(PriorityInfo priorities)
		{
		...
		public IEnumerable<Route> Sort(IEnumerable<Route> routes, IEnumerable<IPartialRanker> rankers, RouteSortTypes sortType)
		{
			...
			var res = routes.GroupBy(r => r.UpdatedDateTime).OrderByDescending(r => r.Key);
